...
def test_caixinha_deposito_saque(user_id):
    ...
    _, bal_acc, bal_pocket, _, _, _ = pocket_withdraw_to_account(user_id, "viagem", 100, "teste")
...
def test_investimento_aporte_resgate(user_id):
    ...
    _, bal_acc, bal_inv, _, _, _ = investment_withdraw_to_account(user_id, "CDB Nubank", 50, "resgate")
