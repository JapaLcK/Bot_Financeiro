...
Gerado em 2026-09-03_115736 por `scripts/whatsapp_qa_vault_harness.py`, chamando `core.handle_incoming.handle_incoming()` direto contra um Postgres isolado e descartável, sem mockar a IA (chamadas OpenAI reais).
...
**Custo:** US$ 0.0184 nesta rodada · US$ 0.2590 acumulado no mês pelos harnesses. 210736 tokens de entrada, 183168 cacheados (87%), cobrados à metade. Preços da tabela de 2026-09-01, sem o whisper (cobrado por minuto) — reconfira antes de citar fora daqui.

**Guarda de afirmações:** 11 afirmação(ões) numérica(s) em resposta de IA · **0 não sustentada(s)** (número que não veio de nenhuma tool nem da mensagem do usuário).
...
>
> Você: sim
> PigBank: ✅ Pronto! *netflix* agora é *gasto fixo*: R$ 44,90 todo dia 3. A Piggy lança sozinha. 🐷
> _caminho: comando (0 chamadas)_
>
...
- resposta a 'sim': '✅ Pronto! *netflix* agora é *gasto fixo*: R$ 44,90 todo dia 3. A Piggy lança sozinha. 🐷'
...
- PC capturado (geladeira): 5DCE39DB
- PC capturado (celular): 71A14C14
...
• Nubank — geladeira
  ...
  🔢 Código: PC5DCE39DB
  🗑️ Apagar: apagar PC5DCE39DB
• Nubank — celular
  💰 Total: R$ 958,80 | Restante: R$ 958,80 (0/12 pagas)
  🔢 Código: PC71A14C14
  🗑️ Apagar: apagar PC71A14C14
> _caminho: comando (0 chamadas)_
>
...
🧾 *Outras compras:*
  • R$ 60,00 | alimentação | 03/09/26 | 60 ifood
  • R$ 150,00 | outros | 03/09/26 | compra no credito
> _caminho: comando (0 chamadas)_
>
> Você: faturas
...
> _caminho: comando (0 chamadas)_
>
> Você: apagar PC5DCE39DB
> PigBank: 🗑️ Parcelamento desfeito (PC5DCE39DB).
...
**Notas:**
- usando CC=2 (compra ifood) e PC=5DCE39DB (parcelamento geladeira)
...
2. *2.000,00* - *Rendimentos*  
   Recebi 2000 de salário

3. *123,45* - *Saúde*  
   Gastei 123,45 na farmácia
...
> PigBank: 🐷 Nos últimos dias, você gastou com saúde:

R$ 123,45

• Total de gastos em saúde
• Outras categorias: transporte (R$ 89,90) e mercado (R$ 50,00)
...
> Você: limite nubank
> PigBank: 🐷 Não tenho o limite do seu cartão Nubank cadastrado. Você já usou R$ 200,00, mas não consigo ver quanto ainda tem disponível. 

Pra saber o limite, você pode cadastrar lá no dashboard. Quer que eu te mande o link?
> _caminho: IA (3 chamadas: gpt-4o-mini-2024-07-18)_
> _guarda: ✅ 1 afirmação(ões), todas sustentadas_
>
...
Pra ver quanto ainda pode gastar, você precisa cadastrar o limite no dashboard. Quer que eu te mande o link?
> _caminho: IA (3 chamadas: gpt-4o-mini-2024-07-18)_
>
