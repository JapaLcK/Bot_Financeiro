...
Gerado em 2026-09-02_233408 por `scripts/whatsapp_qa_vault_harness.py`, chamando `core.handle_incoming.handle_incoming()` direto contra um Postgres isolado e descartável, sem mockar a IA (chamadas OpenAI reais).

**Sumário:** 34 interações — ✅ 28 · ❌ 5 · ⚠️ 0 · 🔍 1

**Caminho:** 16 turno(s) resolvido(s) pela IA · 96 por comando/regex (sem chamada nenhuma) — 50 chamadas OpenAI no total.

**Custo:** US$ 0.0172 nesta rodada · US$ 0.2054 acumulado no mês pelos harnesses. 210704 tokens de entrada, 198912 cacheados (94%), cobrados à metade. Preços da tabela de 2026-09-01, sem o whisper (cobrado por minuto) — reconfira antes de citar fora daqui.

**Guarda de afirmações:** 13 afirmação(ões) numérica(s) em resposta de IA · **0 não sustentada(s)** (número que não veio de nenhuma tool nem da mensagem do usuário).
...
- PC capturado (geladeira): D8E343E2
- PC capturado (celular): E5A39654
...
• Nubank — geladeira
  ...
  🔢 Código: PCD8E343E2
  🗑️ Apagar: apagar PCD8E343E2
• Nubank — celular
  💰 Total: R$ 958,80 | Restante: R$ 958,80 (0/12 pagas)
  🔢 Código: PCE5A39654
  🗑️ Apagar: apagar PCE5A39654
> _caminho: comando (0 chamadas)_
>
...
> _caminho: comando (0 chamadas)_
>
> Você: apagar PCD8E343E2
> PigBank: 🗑️ Parcelamento desfeito (PCD8E343E2).
...
**Notas:**
- usando CC=2 (compra ifood) e PC=D8E343E2 (parcelamento geladeira)
...
> PigBank: 🐷 Você gastou R$ *123,45* com saúde desde o início de setembro. 
...
> Você: limite nubank
> PigBank: 🐷 Não tenho o limite do seu cartão Nubank cadastrado. Você usou R$ 200,00 até agora, mas não consigo ver quanto ainda tem disponível. 

Pra conferir isso, é só cadastrar o limite no dashboard. Quer que eu mande o link pra você?
> _caminho: IA (3 chamadas: gpt-4o-mini-2024-07-18)_
> _guarda: ✅ 1 afirmação(ões), todas sustentadas_
>
...
Pra ver quanto você ainda pode gastar, é só cadastrar o limite no dashboard. Quer que eu mande o link pra você?
> _caminho: IA (3 chamadas: gpt-4o-mini-2024-07-18)_
>
