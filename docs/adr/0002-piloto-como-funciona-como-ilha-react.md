...
- o HTML do mount conterá o markup legado completo e funcional. O bundle só monta
  após validar o contrato esperado; se faltar, atrasar ou recusar o mount, o
  conteúdo e os links de `/cadastro` permanecem utilizáveis. Falha de inicialização
  não pode deixar o mount vazio: deve preservar ou restaurar esse markup;
...
- desligar ou remover a referência ao bundle restaura o markup legado, sem troca
  de rota, servidor ou deploy. Esse é o rollback do piloto.
...
7. rollback ensaiado para o markup legado antes de qualquer exposição.
