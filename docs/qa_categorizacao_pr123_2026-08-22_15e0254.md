...
Gerado por `scripts/category_qa_harness.py --label pr123` contra a árvore `/Users/lucaskuramoti/Desktop/bot/bot_wa`, num Postgres isolado e descartável.

## O que exatamente foi medido (lido em runtime)

- **árvore desta execução:** `/Users/lucaskuramoti/Desktop/bot/bot_wa` — **15e0254 (fix/categorizacao-categoria-custom-roubada, dirty)**
- **árvore comparada (`main`):** `/Users/lucaskuramoti/Desktop/bot/bot_wa/.claude/worktrees/worktree-question-d612ba` — **15c57d7 (worktree-question-d612ba, dirty)**
- ⚠️ **o que está sendo comparado não é “main × PR #123” em estado de laboratório**: é uma árvore contra a outra, no estado `clean`/`dirty` impresso acima. Arquivo modificado e não commitado entra na medição.
...
**Sumário:** 112 casos — ✅ 94 · ❌ 16 · ⚠️ 0 · 🔍 2

> **✅ quer dizer “igual ao comportamento atual”, não “correto”.** 4 dos 94 verdes documentam comportamento que a própria nota chama de indesejável: `B1.44`, `B2.10`, `B2.12`, `B2.13`.
...
| caso | mensagem / cena | esperado | obtido (banco) | reason | veredito | main |
|---|---|---|---|---|---|---|
| `B1.01` | gastei 45 no ifood | `alimentação` | `alimentação` | `local_rule` | ✅ | ✅ (igual) |
| `B1.02` | paguei 32 no almoço | `alimentação` | `alimentação` | `local_rule` | ✅ | ✅ (igual) |
| `B1.03` | gastei 28 na PADARIA | `alimentação` | `alimentação` | `local_rule` | ✅ | ✅ (igual) |
| `B1.04` | gastei 60 no açaí | `alimentação` | `alimentação` | `local_rule` | ✅ | ✅ (igual) |
| `B1.05` | gastei 250 no supermercado | `mercado` | `mercado` | `local_rule` | ✅ | ✅ (igual) |
| `B1.06` | comprei material de limpeza 80 | `mercado` | `mercado` | `local_rule` | ✅ | ✅ (igual) |
| `B1.07` | gastei 120 num jogo de cama | `mercado` | `mercado` | `local_rule` | ✅ | ✅ (igual) |
| `B1.08` | gastei 200 no atacadão | `mercado` | `mercado` | `local_rule` | ✅ | ✅ (igual) |
| `B1.09` | gastei 25 no uber | `transporte` | `transporte` | `local_rule` | ✅ | ✅ (igual) |
| `B1.10` | paguei 180 de gasolina | `transporte` | `transporte` | `local_rule` | ✅ | ✅ (igual) |
| `B1.11` | paguei 90 de passagem de ônibus | `transporte` | `transporte` | `local_rule` | ✅ | ✅ (igual) |
| `B1.12` | paguei 900 de IPVA | `transporte` | `transporte` | `local_rule` | ✅ | ✅ (igual) |
| `B1.13` | gastei 120 na farmácia | `saúde` | `saúde` | `local_rule` | ✅ | ✅ (igual) |
| `B1.14` | paguei 150 na academia | `saúde` | `saúde` | `local_rule` | ✅ | ✅ (igual) |
| `B1.15` | paguei 300 no dentista | `saúde` | `saúde` | `local_rule` | ✅ | ✅ (igual) |
| `B1.16` | paguei 1500 de aluguel | `moradia` | `moradia` | `local_rule` | ✅ | ✅ (igual) |
| `B1.17` | paguei 180 de conta de luz | `moradia` | `moradia` | `local_rule` | ✅ | ✅ (igual) |
| `B1.18` | paguei 120 de internet | `moradia` | `moradia` | `local_rule` | ✅ | ✅ (igual) |
| `B1.19` | gastei 400 com aluguel de carro | `lazer` | `lazer` | `local_rule` | ✅ | ✅ (igual) |
| `B1.20` | gastei 60 no cinema | `lazer` | `lazer` | `local_rule` | ✅ | ✅ (igual) |
| `B1.21` | gastei 250 no show | `lazer` | `lazer` | `local_rule` | ✅ | ✅ (igual) |
| `B1.22` | paguei 400 de hotel | `lazer` | `lazer` | `local_rule` | ✅ | ✅ (igual) |
| `B1.23` | paguei 800 de faculdade | `educação` | `educação` | `local_rule` | ✅ | ✅ (igual) |
| `B1.24` | comprei um livro 45 | `educação` | `educação` | `local_rule` | ✅ | ✅ (igual) |
| `B1.25` | gastei 300 no curso de inglês | `educação` | `educação` | `local_rule` | ✅ | ✅ (igual) |
| `B1.26` | paguei 39,90 de netflix | `assinaturas` | `assinaturas` | `local_rule` | ✅ | ✅ (igual) |
| `B1.27` | paguei 55 do amazon prime | `assinaturas` | `assinaturas` | `local_rule` | ✅ | ✅ (igual) |
| `B1.28` | paguei 34,90 de spotify | `assinaturas` | `assinaturas` | `local_rule` | ✅ | ✅ (igual) |
| `B1.29` | gastei 180 no petshop | `pets` | `pets` | `local_rule` | ✅ | ✅ (igual) |
| `B1.30` | comprei ração 120 | `pets` | `pets` | `local_rule` | ✅ | ✅ (igual) |
| `B1.31` | gastei 90 com vacina do cachorro | `pets` | `pets` | `local_rule` | ✅ | ✅ (igual) |
| `B1.32` | comprei 150 na shopee | `compras online` | `compras online` | `local_rule` | ✅ | ✅ (igual) |
| `B1.33` | gastei 89 na amazon | `compras online` | `compras online` | `local_rule` | ✅ | ✅ (igual) |
| `B1.34` | comprei 200 no mercado livre | `compras online` | `compras online` | `local_rule` | ✅ | ✅ (igual) |
| `B1.35` | gastei 90 no cabeleireiro | `beleza` | `beleza` | `local_rule` | ✅ | ✅ (igual) |
| `B1.36` | paguei 60 na manicure | `beleza` | `beleza` | `local_rule` | ✅ | ✅ (igual) |
| `B1.37` | gastei 45 no barbeiro | `beleza` | `beleza` | `local_rule` | ✅ | ✅ (igual) |
| `B1.38` | comprei 500 de bitcoin | `criptomoedas` | `criptomoedas` | `local_rule` | ✅ | ✅ (igual) |
| `B1.39` | comprei 200 em ethereum | `criptomoedas` | `criptomoedas` | `local_rule` | ✅ | ✅ (igual) |
| `B1.40` | gastei 300 no mercado bitcoin | `investimento_aporte` | `investimento_aporte` | `local_rule` | ✅ | ✅ (igual) |
| `B1.41` | gastei 1000 com tesouro direto | `investimento_aporte` | `investimento_aporte` | `local_rule` | ✅ | ✅ (igual) |
| `B1.42` | comprei 5000 de PETR4 | `investimento_aporte` | `investimento_aporte` | `ticker_match` | ✅ | ✅ (igual) |
| `B1.43` | comprei 5000 de petr4 | `outros` | `outros` | `default` | ✅ | ✅ (igual) |
| `B1.44` | gastei 1000 em investimentos | `investimentos` | `investimentos` | `local_rule` | ✅ | ✅ (igual) |
| `B1.45` | recebi 2000 de resgate | `investimento_resgate` | `investimento_resgate` | `local_rule` | ✅ | ✅ (igual) |
| `B1.46` | recebi 120 de dividendos | `rendimentos` | `rendimentos` | `local_rule` | ✅ | ✅ (igual) |
| `B1.47` | recebi 80 de juros | `rendimentos` | `rendimentos` | `local_rule` | ✅ | ✅ (igual) |
| `B1.48` | paguei 90 de juros do cheque especial | `outros` | `outros` | `default` | ✅ | ✅ (igual) |
| `B1.49` | gastei 70 com zzqwx | `outros` | `outros` | `default` | ✅ | ✅ (igual) |
| `B1.50` | gastei 50 numa sexta-feira | `outros` | `outros` | `default` | ✅ | ✅ (igual) |
| `B2.01` | aprender rifa como lazer → confirmação + regra no banco | `True` | `True` | `None` | ✅ | ✅ (igual) |
| `B2.02` | gastei 20 na rifa | `lazer` | `lazer` | `user_rule` | ✅ | ✅ (igual) |
| `B2.03` | gastei 30 no uber | `lazer` | `lazer` | `user_rule` | ✅ | ✅ (igual) |
| `B2.04` | `categorias` lista a regra criada | `True` | `True` | `None` | ✅ | ✅ (igual) |
| `B2.05` | remover regra <keyword> | `True` | `True` | `None` | ✅ | ✅ (igual) |
| `B2.06` | gastei 20 na rifa | `outros` | `outros` | `default` | ✅ | ✅ (igual) |
| `B2.07` | remover regra <categoria> apaga as N regras dela | `True` | `True` | `None` | ✅ | ✅ (igual) |
| `B2.08` | remover regra inexistente → aviso, sem estourar | `True` | `True` | `None` | ✅ | ✅ (igual) |
| `B2.09` | paguei 39,90 de netflix | `lazer` | `lazer` | `user_rule` | ✅ | ✅ (igual) |
| `B2.10` | gastei 18 na cafeteria | `beleza` | `beleza` | `user_rule` | ✅ | ✅ (igual) |
| `B2.11` | comprei 1000 de PETR4 | `mercado` | `investimento_aporte` | `ticker_match` | ❌ | ❌ (igual) |
| `B2.12` | `criar categoria viagens` (sem ' linkar ') cria linha em user_categori | `0` | `0` | `None` | ✅ | ✅ (igual) |
| `B2.13` | `criar categoria viagens linkar decolar` cria linha em user_categories | `0` | `0` | `None` | ✅ | ✅ (igual) |
| `B2.14` | gastei 300 na decolar | `viagens` | `viagens` | `user_rule` | ✅ | ✅ (igual) |
| `B3.01` | gastei 400 com a namorada | `gastos com namorada` | `gastos com namorada` | `user_category` | ✅ | ✅ (igual) |
| `B3.02` | gastei 200 com a família | `saúde da família` | `saúde da família` | `user_category` | ✅ | ✅ (igual) |
| `B3.03` | gastei 70 com zzqwx | `outros` | `outros` | `default` | ✅ | ✅ (igual) |
| `B3.04` | gastei 50 com o cachorro do vizinho | `cachorro do vizinho` | `cachorro do vizinho` | `user_category` | ✅ | ✅ (igual) |
| `B3.05` | gastei 50 com o cachorro | `cachorro` | `cachorro do vizinho` | `user_category` | ❌ | ❌ (igual) |
| `B3.06` | create_user_category(uid, "Saúde") com a system "saúde" semeada | `CATEGORIA_DUPLICADA` | `CATEGORIA_DUPLICADA` | `None` | ✅ | ✅ (igual) |
| `B3.07` | gastei 100 com a namorada | `gastos com namorada` | `gastos com namorada` | `user_category` | ✅ | ✅ (igual) |
| `B3.08` | gastei 100 com a namorada | `outros` | `outros` | `default` | ✅ | ✅ (igual) |
| `B3.09` | renomear categoria custom faz cascata em launches.categoria | `gastos com a esposa` | `gastos com a esposa` | `None` | ✅ | ✅ (igual) |
| `B3.10` | gastei 90 com a esposa | `gastos com a esposa` | `gastos com a esposa` | `user_category` | ✅ | ✅ (igual) |
| `B3.11` | gastei 90 com a namorada | `outros` | `outros` | `default` | ✅ | ✅ (igual) |
| `B3.12` | apagar categoria custom que tem lançamentos | `CATEGORIA_COM_LANCAMENTOS` | `CATEGORIA_COM_LANCAMENTOS` | `None` | ✅ | ✅ (igual) |
| `B4.01` | custom JÁ existe: 'gastei 80 com a namorada no cinema' grava alguma re | `False` | `False` | `None` | ✅ | ✅ (igual) |
| `B4.02` | gastei 400 com a namorada | `gastos com namorada` | `gastos com namorada` | `user_category` | ✅ | ✅ (igual) |
| `B4.03` | 200 namorada cinema | `gastos com namorada` | `lazer` | `user_rule` | ❌ | ❌ (igual) |
| `B4.04` | confirmação de foto de cupom (add_from_entities com category_reason='i | `False` | `False` | `None` | ✅ | **❌ → ✅** |
| `B4.05` | 300 namorada cinema | `gastos com namorada` | `lazer` | `user_rule` | ❌ | ❌ (igual) |
| `B5.01` | lançamento no WhatsApp grava pending recategorize_launch_offer | `recategorize_launch_offer` | `recategorize_launch_offer` | `None` | ✅ | ✅ (igual) |
| `B5.02` | _apply_recategorize(..., 'lazer') grava lazer | `lazer` | `lazer` | `None` | ✅ | ✅ (igual) |
| `B5.03` | _apply_recategorize com rótulo acentuado 'saúde' | `saúde` | `saúde` | `None` | ✅ | ✅ (igual) |
| `B5.04` | _apply_recategorize com nome de categoria CUSTOM acentuada | `saúde da família` | `saude da familia` | `None` | ❌ | ❌ (igual) |
| `B5.05` | a lista interativa de recategorização inclui a categoria custom? | `True` | `False` | `None` | ❌ | ❌ (igual) |
| `B6.01` | gastei 70 com zzqwx | `lazer` | `lazer` | `user_rule` | ✅ | ✅ (igual) |
| `B6.02` | gastei 70 com zzqwx | `outros` | `outros` | `default` | ✅ | ✅ (igual) |
| `B6.03` | gastei 400 com a namorada | `outros` | `outros` | `default` | ✅ | ✅ (igual) |
| `B7.01` | frase sem keyword nenhuma, usuário Pro → passo 6 (GPT) | `categoria plausível` | `None` | `None` | 🔍 | 🔍 (igual) |
| `B7.02` | cross-check IA × determinístico (launches.py:418) | `regra determinística vence a IA quando contradiz` | `None` | `None` | 🔍 | 🔍 (igual) |
| `B8.01` | 77,90 mercado | `mercado` | `mercado` | `local_rule` | ✅ | ✅ (igual) |
| `B8.02` | 25 uber | `transporte` | `transporte` | `local_rule` | ✅ | ✅ (igual) |
| `B8.03` | 1500 aluguel | `moradia` | `moradia` | `local_rule` | ✅ | ✅ (igual) |
| `B8.04` | pig gastei 45 no ifood | `alimentação` | `None` | `None` | ❌ | ❌ (igual) |
| `B8.05` | pig 60 cinema | `lazer` | `None` | `None` | ❌ | ❌ (igual) |
| `B8.06` | 40 no rango | `alimentação` | `outros` | `default` | ❌ | ❌ (igual) |
| `B8.07` | paguei 25 de cerva | `alimentação` | `outros` | `default` | ❌ | ❌ (igual) |
| `B8.08` | gastei 30 no mercadinho | `mercado` | `mercado` | `local_rule` | ✅ | ✅ (igual) |
| `B8.09` | gastei 60 no acai | `alimentação` | `alimentação` | `local_rule` | ✅ | ✅ (igual) |
| `B8.10` | paguei 39,90 da netflis | `assinaturas` | `outros` | `default` | ❌ | ❌ (igual) |
| `B8.11` | gastei 120 na farmacia de manha | `saúde` | `saúde` | `local_rule` | ✅ | ✅ (igual) |
| `B8.12` | PAGUEI 180 DE GASOLINA | `transporte` | `transporte` | `local_rule` | ✅ | ✅ (igual) |
| `B8.13` | COMPREI 150 NA SHOPEE | `compras online` | `compras online` | `local_rule` | ✅ | ✅ (igual) |
| `B8.14` | entao eu gastei 45 reais la no ifood hoje de manha | `alimentação` | `None` | `None` | ❌ | ❌ (igual) |
| `B8.15` | ahn paguei 180 de gasolina acho que foi ontem | `transporte` | `None` | `None` | ❌ | ❌ (igual) |
| `B8.16` | gastei 30 no uber e 45 no ifood | `[('transporte', 'despesa', 30.0), ('alimentação', 'despesa', 45.0)]` | `[('transporte', 'despesa', 30.0), ('alimentação', 'despesa', 45.0)]` | `local_rule · local_rule` | ✅ | ✅ (igual) |
| `B8.17` | paguei 120 de internet e 180 de luz | `[('moradia', 'despesa', 120.0), ('moradia', 'despesa', 180.0)]` | `[('moradia', 'despesa', 120.0), ('moradia', 'despesa', 180.0)]` | `local_rule · local_rule` | ✅ | ✅ (igual) |
| `B8.18` | 35 padaria e 80 farmacia | `[('alimentação', 'despesa', 35.0), ('saúde', 'despesa', 80.0)]` | `[('alimentação', 'despesa', 35.0), ('saúde', 'despesa', 80.0)]` | `local_rule · local_rule` | ✅ | ✅ (igual) |
| `B8.19` | 35 padaria 80 farmacia | `[('alimentação', 'despesa', 35.0), ('saúde', 'despesa', 80.0)]` | `[('alimentação', 'despesa', 35.0)]` | `local_rule` | ❌ | ❌ (igual) |
| `B8.20` | gastei 35 na padaria 80 na farmacia | `[('alimentação', 'despesa', 35.0), ('saúde', 'despesa', 80.0)]` | `[('alimentação', 'despesa', 35.0)]` | `local_rule` | ❌ | ❌ (igual) |
| `B8.21` | gastei 30 no uber e no ifood | `[('transporte', 'despesa', 30.0)]` | `[('alimentação', 'despesa', 30.0)]` | `local_rule` | ❌ | ❌ (igual) |
...
- **reason do `infer_category`:** `user_rule`
- **diff de `user_category_rules`:** (nenhuma regra nova)
- **nota:** regras vivas antes deste lançamento: ['cinema→lazer'] — o lançamento caiu em `lazer` por `user_rule`. Mesmo SEM a regra com 'namorada', a cena termina fora da categoria custom: a regra `cinema→lazer` (aprendida no mesmo evento, e que o guard do #123 não recusa) vence no passo 3, antes do passo 4.
