...
Gerado em 2026-09-02_2002 por `scripts/whatsapp_qa_vault_harness.py`, chamando `core.handle_incoming.handle_incoming()` direto contra um Postgres isolado e descartável, sem mockar a IA (chamadas OpenAI reais).
...
**Custo:** US$ 0.0136 nesta rodada · US$ 0.0501 acumulado no mês pelos harnesses. 151204 tokens de entrada, 125952 cacheados (83%), cobrados à metade. Preços da tabela de 2026-09-01, sem o whisper (cobrado por minuto) — reconfira antes de citar fora daqui.
...
> PigBank: 🐷 Nos seus gastos de saúde, você torrou:

R$ *123,45*  
Só no dia 1º e 2 de setembro.

• *Transporte:* R$ 89,90  
• *Mercado:* R$ 50,00  

Se precisar de mais detalhes ou quiser ver outros períodos, é só avisar!
> _caminho: IA (2 chamadas: gpt-4o-mini-2024-07-18)_
...
> Você: limite nubank
> PigBank: 🐷 Parece que o limite do seu cartão Nubank não tá cadastrado. Pra ver quanto sobra, você precisa cadastrar o limite no dashboard. 

Se precisar de ajuda com isso, é só me avisar!
> _caminho: IA (3 chamadas: gpt-4o-mini-2024-07-18)_
>
> Você: quanto ainda posso gastar no nubank
> PigBank: 🐷 Não consegui pegar o limite do seu Nubank, porque ele não tá cadastrado. Pra ver quanto você ainda pode gastar, é só cadastrar o limite no dashboard. 
