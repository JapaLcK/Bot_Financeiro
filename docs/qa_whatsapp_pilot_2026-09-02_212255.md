...
Gerado em 2026-09-02_212255 por `scripts/whatsapp_qa_vault_harness.py`, chamando `core.handle_incoming.handle_incoming()` direto contra um Postgres isolado e descartável, sem mockar a IA (chamadas OpenAI reais).

**Sumário:** 11 interações — ✅ 5 · ❌ 5 · ⚠️ 0 · 🔍 1

**Caminho:** 10 turno(s) resolvido(s) pela IA · 12 por comando/regex (sem chamada nenhuma) — 40 chamadas OpenAI no total.

**Custo:** US$ 0.0124 nesta rodada · US$ 0.1212 acumulado no mês pelos harnesses. 149152 tokens de entrada, 138624 cacheados (93%), cobrados à metade. Preços da tabela de 2026-09-01, sem o whisper (cobrado por minuto) — reconfira antes de citar fora daqui.
...
> PigBank: Você poderia especificar o que você quer dizer com 'esse mês'? Você se refere ao mês atual ou a um mês específico?
> _caminho: IA (1 chamada: gpt-4o-mini-2024-07-18)_
>
...
> PigBank: Você gostaria de saber o total gasto em um período específico?
> _caminho: IA (1 chamada: gpt-4o-mini-2024-07-18)_
>
...
> PigBank: 🐷 Olha só, você gastou R$ *123,45* com saúde nos últimos dias.
...
> Você: limite nubank
> PigBank: 🐷 Parece que o limite do seu cartão Nubank não tá cadastrado. Você só usou R$ 200,00 até agora. 

Pra ver quanto sobra, é só cadastrar o limite no seu dashboard. Quer que eu te mande o link?
> _caminho: IA (3 chamadas: gpt-4o-mini-2024-07-18)_
> _guarda: ✅ 1 afirmação(ões), todas sustentadas_
>
> Você: quanto ainda posso gastar no nubank
> PigBank: 🐷 Não consegui pegar o limite do seu Nubank porque ele não tá cadastrado. Pra saber quanto você ainda pode gastar, é só cadastrar o limite no dashboard. 

Se precisar de ajuda pra isso, é só me avisar!
> _caminho: IA (3 chamadas: gpt-4o-mini-2024-07-18)_
>
